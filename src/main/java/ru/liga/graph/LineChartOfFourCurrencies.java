...
public class LineChartOfFourCurrencies extends JFrame implements IGraph{
    ...
    private XYDataset createDataset(List <DateAndCourse> resultForCurrencyOneType, String currencyOneType,
                                    ...
                                    List <DateAndCourse> resultForCurrencyThreeType, String currencyThreeType,
                                    List <DateAndCourse> resultForCurrencyFourType, String currencyFourType) {
